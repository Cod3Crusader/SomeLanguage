...
open class NameResolver(val parent: NameResolver? = null) {
    ...
    fun resolveFunc(id: String) = resolve(id) as? Symbol.Function ?: throw CompileError.UnresolvedIdentifier(id)
    fun resolveVar(id: String) = resolve(id) as? Variable ?: throw CompileError.UnresolvedIdentifier(id)
